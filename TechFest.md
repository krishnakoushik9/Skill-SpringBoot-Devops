...
**Our Solution:** Share the entire app via Bluetooth/Nearby Share.

#### How It Works:
1. One student downloads the app (at school/library with WiFi)
2. Opens the app, goes to Profile → Share APK
3. App locates its own APK file on device
...
- **Stats Hero Card:** Shows progress at a glance
...
- [x] Stats hero card with animations
- [x] Staggered animations throughout
- [x] Progress screen with charts (fl_chart)
- [x] Study dashboard (tasks screen)
...
- [x] Peer-to-peer content sharing
